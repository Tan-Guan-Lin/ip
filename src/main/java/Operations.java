...
public class Operations {
            ...
            while (sc.hasNextLine()) {
                ...
                try {
                    ...
                    case "D":
                        ...
                        taskList.add(new Deadline(task[2], Integer.parseInt(task[1]) == 1, task[3].replace('T', ' ')));
                        break;
                    case "E":
                        if (task.length != 5) {
                            throw new IllegalArgumentException("Format error");
                        }
                        taskList.add(new Event(task[2], Integer.parseInt(task[1]) == 1, task[3].replace('T', ' '), task[4].replace('T', ' ')));
                        break;
                    default:
    ...
    public static void createTodo(String input) {
        ...
        System.out.println("Now you have " + getListSize() + " tasks in the list.");
    }
